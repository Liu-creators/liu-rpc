...
public class ZooKeeperRegistry implements Registry{
    ...
    public void init(RegistryConfig registryConfig) {
        ...
        client = CuratorFrameworkFactory
                .builder()
                .connectString(registryConfig.getAddress()) // 设置zookeeper的服务器地址
                .retryPolicy(new ExponentialBackoffRetry(Math.toIntExact(registryConfig.getTimeout()), 3)) // 指数退避重试策略 最多重试 3 次
                .build();
